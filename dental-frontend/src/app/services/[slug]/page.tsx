...
export default async function ServicePage({ 
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section - Matching Service Template */}
      ...
      {/* Trust Bar - Matching Service Template */}
      ...
      {/* Intro Section - Matching Service Template */}
      {intro.title && (
      ...
      {/* Benefits Section - Matching Service Template */}
      {benefits.length > 0 && (
      ...
      {/* Process Timeline - Matching Service Template */}
      {process.length > 0 && (
      ...
      {/* Pricing Section - Matching Service Template */}
      {pricing.length > 0 && (
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
      ...
      {/* Doctor Section - Matching Service Template */}
      {doctor.name && (
        <section className="py-20 bg-gradient-to-b from-white to-sky-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
      ...
      {/* FAQ Section - Matching Service Template */}
      {faqs.length > 0 && (
        <section className="py-20 bg-white">
      ...
      {/* CTA Section - Matching Service Template */}
